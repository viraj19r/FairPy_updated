...
class HellingerDistanceGender(HellingerDistance.HellingerDistance):
    ...
    def hellinger_distance_between_bias_swapped_context(self, model, tokenizer, embedding, device, transformer, P=None, A=None, isMasked=False, mask=''):
        ...
        male_context = np.genfromtxt(sys.path[1]+"data/kl_corpus_male_context.txt", dtype=str, delimiter="\n", encoding='utf-8')
        female_context = np.genfromtxt(sys.path[1]+"data/kl_corpus_female_context.txt", dtype=str, delimiter="\n", encoding='utf-8')
