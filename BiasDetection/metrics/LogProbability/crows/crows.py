    ...
    def _likelihood_score(self):
        ...
        with tqdm(total=total) as pbar:
            for index, data in df_data.iterrows():
                ...
                df_score = pd.concat([df_score, df2],ignore_index=True)
    ...
    def _read_data(self, input_file):
        ...
        with open(input_file) as f:
            ...
            for row in reader:
                ...
                # df_data = df_data.concat(df_item, ignore_index=True)
                df2 = pd.DataFrame(df_item, index=[0])
